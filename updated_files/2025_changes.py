...
ds_245 = xr.open_dataarray("ensemble_2025_avg_ssp245.nc")
ds_585 = xr.open_dataarray("ensemble_2025_avg_ssp585.nc")
...
print("\nChill Hour Comparison for 2025 (SSP2-4.5 vs SSP5-8.5) - California Only\n")
