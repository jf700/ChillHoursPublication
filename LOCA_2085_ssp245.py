...
# === Settings ===
target_years = [2083, 2084, 2085, 2086, 2087]
Tc_celsius = 7.2
processed_data_filename = "2085_245_ensemble_chill_hours.nc"
shapefile_path = r"C:\Users\Josh\Documents\ChillResearch\Fruit_Nuts\Fruits_Nuts.shp"

model_files = {
    "MIROC6": {
        "tasmin": "tasmin.MIROC6.ssp245.r1i1p1f1.2075-2100.LOCA_16thdeg_v20220413.west.nc",
        "tasmax": "tasmax.MIROC6.ssp245.r1i1p1f1.2075-2100.LOCA_16thdeg_v20220413.west.nc"
    },
    "CanESM5": {
        "tasmin": "tasmin.CanESM5.ssp245.r1i1p1f1.2075-2100.LOCA_16thdeg_v20220413.west.nc",
        "tasmax": "tasmax.CanESM5.ssp245.r1i1p1f1.2075-2100.LOCA_16thdeg_v20220413.west.nc"
    },
    "HadGEM3-GC31-LL": {
        "tasmin": "tasmin.HadGEM3-GC31-LL.ssp245.r1i1p1f3.2075-2100.LOCA_16thdeg_v20220413.west.nc",
        "tasmax": "tasmax.HadGEM3-GC31-LL.ssp245.r1i1p1f3.2075-2100.LOCA_16thdeg_v20220413.west.nc"
    },
    "CNRM-CM6-1": {
        "tasmin": "tasmin.CNRM-CM6-1.ssp245.r1i1p1f2.2075-2100.LOCA_16thdeg_v20220413.west.nc",
        "tasmax": "tasmax.CNRM-CM6-1.ssp245.r1i1p1f2.2075-2100.LOCA_16thdeg_v20220413.west.nc"
    }
}
...
ax.set_title("Ensemble Chill Hours (Nov-Feb, 2083–2087) for Fruit and Nuts Area - SSP2-4.5", fontsize=12)
...
print(f"Scenario: SSP2-4.5, 2085")
