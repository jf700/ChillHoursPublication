...
Tc_celsius = 7.2
processed_data_filename = "2045_585_ensemble_chill_hours.nc"
...
model_files = {
    "MIROC6": {
        "tasmin": [
            "tasmin.MIROC6.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmin.MIROC6.ssp585.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ],
        "tasmax": [
            "tasmax.MIROC6.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmax.MIROC6.ssp585.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ]
    },
    "CanESM5": {
        "tasmin": [
            "tasmin.CanESM5.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmin.CanESM5.ssp585.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ],
        "tasmax": [
            "tasmax.CanESM5.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmax.CanESM5.ssp585.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ]
    },
    "HadGEM3-GC31-LL": {
        "tasmin": [
            "tasmin.HadGEM3-GC31-LL.ssp585.r1i1p1f3.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmin.HadGEM3-GC31-LL.ssp585.r1i1p1f3.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ],
        "tasmax": [
            "tasmax.HadGEM3-GC31-LL.ssp585.r1i1p1f3.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmax.HadGEM3-GC31-LL.ssp585.r1i1p1f3.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ]
    },
    "CNRM-CM6-1": {
        "tasmin": [
            "tasmin.CNRM-CM6-1.ssp585.r1i1p1f2.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmin.CNRM-CM6-1.ssp585.r1i1p1f2.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ],
        "tasmax": [
            "tasmax.CNRM-CM6-1.ssp585.r1i1p1f2.2015-2044.LOCA_16thdeg_v20220413.west.nc",
            "tasmax.CNRM-CM6-1.ssp585.r1i1p1f2.2045-2074.LOCA_16thdeg_v20220413.west.nc"
        ]
    }
}
...
ax.set_title("Ensemble Chill Hours (Nov-Feb, 2043–2047) for Fruit and Nuts Area - SSP5-8.5", fontsize=12)
...
print(f"Scenario: SSP5-8.5, 2045")
